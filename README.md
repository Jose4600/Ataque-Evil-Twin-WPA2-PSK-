...
Una vez hagamos esto nos saldra una pestaña nueva, Airgeddon lanza un escaneo de redes cercanas. Esperamos unos segundos y lo detenemos. Aparece la lista de redes detectadas; seleccionamos la red objetivo (en nuestro caso, CETI, canal numero 52), lo que carga automáticamente su SSID, BSSID y canal.
